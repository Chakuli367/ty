...
const avatarStyles = {
  ...
  Phoenix: {
    ...
    bgClass:
      "bg-gradient-to-r from-orange-50 to-red-100 dark:from-orange-950 dark:to-red-900",
    ...
    >
      ...
      <div className="mb-6 space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div
              className={`w-12 h-12 rounded-full bg-gradient-to-r ${style.gradient} flex items-center justify-center`}
            >
        ...
        <div className="space-y-4">
          {messages.map((message) => (
            ...
            >
              {message.role === "assistant" && (
                <div
                  className={`w-8 h-8 rounded-full bg-gradient-to-r ${style.gradient} flex items-center justify-center flex-shrink-0`}
                >
          ...
          {isLoading && (
            <div className="flex items-start gap-3">
              <div
                className={`w-8 h-8 rounded-full bg-gradient-to-r ${style.gradient} flex items-center justify-center`}
              >
                <Bot className="w-4 h-4 text-white" />
              </div>
      ...
      <style jsx global>{`
        .metallic-bg {
          ...
          animation: metallic-gradient 15s ease infinite;
          position: relative;
        }
        ...
        .metallic-bg::before {
          ...
          pointer-events: none;
          animation: metallic-sheen 8s linear infinite;
          z-index: 0;
        }
